    ...
    return (
      ...
      <div>
          ...
          <div className='w-fit grid grid-cols-4 gap-9 mx-24 '>
            ...
            <div className='bg-white rounded-xl shadow-lg'>
              <div className='p-5 flex flex-col'>
                ...
                <p className='text-md mt-3'>Ask an AI to plan an automatic date itenerary for you, since you're too busy thinking about everything else! You may be busy but a date is always necessary if you still want to have a relationship. </p>
                <a href='#' className='border-b-4 border-r-4 text-center bg-pink-300 text-pink-700 py-2 rounded-lg font-semibold mt-6 hover:bg-pink-500 focus:scale-95 transition-all duration-200 ease-out'>Explore</a>
              </div>
            </div>
            ...
            <div className='bg-white rounded-xl shadow-lg'>
              <div className='p-5 flex flex-col'>
                ...
                <p className='text-md mt-3'>Keeping track of dates are mundane, But through the calender it would allow you to keep track of special events with you and your partner. For e.g, Birthdays, Anniversaries, etc. </p>
                <a href='#' className='border-b-4 border-r-4 text-center bg-pink-300 text-pink-700 py-2 rounded-lg font-semibold mt-6  hover:bg-pink-500 focus:scale-95 transition-all duration-200 ease-out'>Explore</a>
              </div>
            </div>
          </div>
        ...
        <div className='flex flex-col items-center justify-center'>
          <Link href='/quiz' className=' border-b-4 border-r-4 mb-5 -mt-6 text-center bg-pink-300 text-pink-700 py-2 px-5 rounded-lg font-semibold  hover:bg-pink-500 focus:scale-95 transition-all duration-200 ease-out'>Retake the tendency Quiz ✨</Link>
        </div>
      </div>
